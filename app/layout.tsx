...
export const metadata: Metadata = {
  ...
  description: 'Офіційний підбір та легалізація робітників з Узбекистану, Індії, Бангладеш, Непалу для виробничих та аграрних підприємств України. Вартість від $500 за працівника, оплата комісії після виходу. 100% захист від мобілізації згідно ст. 23 ЗУ.',
  ...
  openGraph: {
    ...
    description: 'Офіційне працевлаштування в штат вашого ТОВ. Вартість від $500 за працівника, комісія строго після виходу. Заміна за 48 годин.',
    locale: 'uk_UA',
    type: 'website',
  },
  verification: {
