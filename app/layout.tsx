...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Підбір та завіз іноземців на роботу в Україну | Трудові мігранти під ключ — Recruiter I Club',
    template: '%s | Recruiter I Club',
  },
  description: 'Офіційний підбір, завіз іноземців та легалізація трудових мігрантів з Узбекистану, Індії, Бангладеш, Непалу для виробництва, будівництва та агросектору України. 100% захист від мобілізації (ст. 23 ЗУ). Вартість від $500/люд. Гарантія заміни.',
  keywords: [
    'підбір іноземців на роботу в україну',
    'завіз іноземців',
    'завезення іноземців в україну',
    'завоз иностранцев',
