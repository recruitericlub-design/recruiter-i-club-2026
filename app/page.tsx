...
export const metadata: Metadata = {
  title: 'Підбір та завіз іноземців на роботу в Україну — Трудові мігранти під ключ | Recruiter I Club',
  description: 'Офіційний підбір та завіз іноземців на роботу в Україну. Легальні трудові мігранти та робітники з Узбекистану, Індії, Непалу для виробництва, складів та будівництва. 100% захист від мобілізації (ст. 23 ЗУ).',
  keywords: 'підбір іноземців на роботу в україну, завіз іноземців, завоз иностранцев, завоз трудовых мигрантов, завезення трудових мігрантів, подбор иностранцев на работу в украину, імпорт робочої сили в україну, дозвіл на працевлаштування іноземців, працевлаштування іноземців в україні, підбір персоналу, робітники з азії, працівники з узбекистану, стаття 23 зу мобілізація, recruiter i club',
  alternates: {
