...
export const metadata: Metadata = {
  title: 'Recruiter I Club — Підбір та легалізація робітничого персоналу з Азії «під ключ»',
  description: 'Офіційний підбір та легалізація робітничого персоналу з Узбекистану та країн Азії під ключ для підприємств України. Закриваємо дефіцит від 3 до 50+ робітників. Ліцензія Мінсоцполітики №1428. 100% захист від мобілізації (ст. 23 ЗУ). Комісія тільки після виходу на зміну.',
  keywords: 'підбір персоналу з азії, робітники з узбекистану, працівники з азії в україну, аутсорсинг робочої сили, дозвіл на роботу іноземця дцз, лінійний персонал, зварювальники узбекистан, будівельники з азії, кадрові агенції київ, стаття 23 зу мобілізація, іноземна робоча сила під ключ, recruiter i club',
  alternates: {
    canonical: 'https://www.recruiter-i.club/',
  },
  openGraph: {
    title: 'Recruiter I Club — Підбір та легалізація робітничого персоналу з Азії «під ключ»',
    description: 'Офіційний підбір та легалізація робітників з Узбекистану, Індії та Азії для підприємств України. Ліцензія Мінсоцполітики №1428. Комісія сплачується виключно після виходу людей на зміну.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Recruiter I Club — Міжнародний рекрутинг іноземної робочої сили в Україну',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Recruiter I Club — Підбір та легалізація персоналу з Азії',
    description: 'Офіційний імпорт робітничої сили з Узбекистану та Азії під ключ. Захист від мобілізації (ст. 23 ЗУ). Гарантія заміни 100%. Комісія тільки в кінці.',
